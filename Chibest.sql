...
CREATE TABLE Warehouse (
    ...
    BranchId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES [Branch](Id) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Product] (
    ...
    CategoryId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Category](Id) ON DELETE CASCADE,
...
CREATE TABLE ProductPriceHistory (
    ...
    ProductId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Product](Id) ON DELETE CASCADE,
    BranchId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES [Branch](Id) ON DELETE CASCADE, -- NULL = giá chung cho tất cả chi nhánh
);
GO
...
CREATE TABLE BranchStock (
    Id UNIQUEIDENTIFIER DEFAULT NEWID() PRIMARY KEY,
    ProductId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Product](Id) ON DELETE CASCADE,
    BranchId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Branch](Id) ON DELETE CASCADE,
...
CREATE TABLE PurchaseOrder (
    ...
    WarehouseId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES [Warehouse](Id) ON DELETE CASCADE,                        -- Kho nhận
    EmployeeId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES [Account](Id),                           -- Nhân viên xác nhận giao dịch
    SupplierId UNIQUEIDENTIFIER FOREIGN KEY REFERENCES [Account](Id) ON DELETE CASCADE,                           
);
GO
...
CREATE TABLE PurchaseOrderDetail (
    ...
    Note NVARCHAR(MAX),
    PurchaseOrderId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [PurchaseOrder](Id) ON DELETE CASCADE,
    ProductId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Product](Id) ON DELETE CASCADE
);
GO
...
CREATE TABLE TransferOrderDetail (
    ...
    Discount DECIMAL(5,2) NOT NULL DEFAULT 0,
    Note NVARCHAR(MAX),
    TransferOrderId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [TransferOrder](Id) ON DELETE CASCADE,
    ProductId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Product](Id) ON DELETE CASCADE
);
GO
...
CREATE TABLE PurchaseReturnDetail (
    ...
    Note NVARCHAR(MAX),
    PurchaseReturnId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [PurchaseReturn](Id) ON DELETE CASCADE,
    ProductId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Product](Id) ON DELETE CASCADE
);
GO
...
CREATE TABLE StockAdjustment (
    ...
    WarehouseId UNIQUEIDENTIFIER NULL FOREIGN KEY REFERENCES [Warehouse](Id) ON DELETE CASCADE,
...
CREATE TABLE SupplierDebt (
    Id UNIQUEIDENTIFIER DEFAULT NEWID() PRIMARY KEY,
    SupplierId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [Account](Id) ON DELETE CASCADE,
...
CREATE TABLE SupplierDebtHistory (
    Id UNIQUEIDENTIFIER DEFAULT NEWID() PRIMARY KEY,
    SupplierDebtId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES [SupplierDebt](Id) ON DELETE CASCADE,
...
CREATE TABLE BranchDebtHistory (
    ...
    BranchDebtId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES BranchDebt(Id) ON DELETE CASCADE,
